(ns chapter01.core)
 ...
 ; repeat the same things a few times with dotimes
 (dotimes [i 10] (println (str "hello" i)))

; take the first 10 integers from 0
(take 10 (iterate inc 0))

; reuse last result using *n
(def tens *1)
...
; #() is a special notation to quickly create macros
(filter #(= 2 %) tens)
...
; define a method with documentation so we can reuse it later
