...
return alert(example.crossover.shared.make_example_text());
});
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,numbers);
};
...
add_some_numbers.cljs$lang$applyTo = (function (arglist__3751){
var numbers = cljs.core.seq(arglist__3751);
